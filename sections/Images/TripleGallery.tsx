        ...
        <>
            {items && items.map((item) => (
                <div class="relative flex w-full flex-col items-center justify-center">
                    <a class={`w-full h-full relative overflow-hidden`}
                        href={item.link?.url} >
                        <img
                            class={`w-full h-full`}
                            src={item.image}
                    ...
                    ">
                        ...
                        <h2 class={`max-w-[275px] ${item.flag ? "mb-6" : "mb-12"} font-bold text-xl text-white`}>
                        {item.title}
                        </h2>
                        {item.flag && (
                            <img class="max-w-[150px]" src={item.flag} />
                        )}
                        {!item.flag && (
