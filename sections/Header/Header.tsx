...
import { HEADER_HEIGHT_DESKTOP, HEADER_HEIGHT_MOBILE, NAVBAR_HEIGHT_MOBILE, 
// SEARCHBAR_DRAWER_ID,
// SEARCHBAR_POPUP_ID,
SIDEMENU_CONTAINER_ID, SIDEMENU_DRAWER_ID, } from "../../constants.ts";
import Menu from "../../islands/Menu.tsx";
// import { useScript } from "deco/hooks/useScript.ts";
import WishlistClick from "../../components/header/WishlistClick.tsx";
import { useDevice as useDevice, useSection as useSection } from "@deco/deco/hooks";
      ...
      <div class="flex flex-col gap-4 pt-5">
        <div class="container flex justify-between items-center">
          ...
          <div class="flex gap-4">
            <a class="text-white hover:!bg-transparent btn btn-sm font-normal btn-ghost no-animation gap-2 flex items-center" href="#1840087127-0">
