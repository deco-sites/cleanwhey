...
export default function TextImage({
  ...
  return (
    <div
      className={`flex flex-col w-full mt-2.5  desktop:mt-5 desktop-sm:container ${
        margem ? "mb-14" : ""
      }
        ${marginYDesktop ? `desktop:my-[${marginYDesktop}px]` : ""}
        ${marginYMobile ? `desktop:my-[${marginYMobile}px]` : ""}
        `}
    >
      <div
