...
function Question({ question, answer }: Question) {
    return (
      <details open class="m-auto collapse collapse-open collapse-arrow border border-gray-100 bg-white">
...
export default function NutritionalInformation (props: Props) {
    const {id, title, table, ingredients, nutritionalPromotionImage, questions} = props;
