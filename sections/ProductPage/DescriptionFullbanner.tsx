        ...
        <section>
            <div class="relative w-full pb-8 md:pb-16">
                <Picture>
                    ...
                    />
                    <img src={banner.desktop.src} alt={title} class="w-full object-cover" />
                </Picture>
                <div class="absolute w-full top-0 left-0 h-full flex flex-col md:flex-row items-center">
                    <div class={"flex px-4 pt-12 md:px-0 md:items-start items-center flex-col md:flex-row h-auto gap-8 md:gap-16 container justify-end "}>
                        <div class="max-w-[384px]">
                            <h2 class="font-bold text-white text-[32px] mb-2 leading-9 text-center md:text-start">{title}</h2>
                            <p class="font-bold text-base text-white mb-4 text-center md:text-start">{subtitle}</p>
                            {content && (
                                <div class={"text-white [&>ul]:pl-8 [&>ul>li]:mb-2 [&>ul>li]:!list-disc"} dangerouslySetInnerHTML={{__html: content}} />
                            )}
                        </div>
                        <div class="bg-white rounded-lg p-4 max-w-[384px]">
                            ...
                            {rightCard?.content && (
                                <div class="font-normal text-gray-300 font-base [&>ul]:pl-8 [&>ul>li]:mb-2 [&>ul>li]:!list-disc" 
