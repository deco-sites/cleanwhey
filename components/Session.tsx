...
export default function Session({ minicart, wishlist, user, mode = "lazy" }: Props) {
    ...
    return (<>
      {/* Minicart Drawer */}
      <Drawer id={MINICART_DRAWER_ID} class="drawer-end z-50" aside={<Drawer.Aside title="Sua sacola de Compras" drawer={MINICART_DRAWER_ID}>
            <div class="h-full flex flex-col bg-base-100 items-center justify-start overflow-auto" style={{
