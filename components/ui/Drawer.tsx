    ...
    >
      <div class={`${drawer == "sidemenu-drawer" ? "bg-orange-300" : ""}`}>
        ...
        <label for={drawer} aria-label="X" class="btn btn-ghost text-white">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 6 6 18M6 6l12 12" stroke={`${drawer == "sidemenu-drawer" ? "#ffffff" : "#464B59"}`} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        </label>
        </div>
        <div class="flex justify-between items-center">
          <a
